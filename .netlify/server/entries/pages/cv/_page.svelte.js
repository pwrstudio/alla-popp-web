...
const css = {
  code: ".cv{margin-top:30px}.cv .cv-content{font-size:16.4px;line-height:1em;margin-top:15px;margin-bottom:45px}.cv .cv-content h2{font-size:16.4px;line-height:1em;color:#ffffff;text-transform:uppercase;background:#8c8c8b;display:inline-block;margin:0}.cv .cv-content p{margin-top:0;max-width:90ch;color:#8c8c8b;letter-spacing:-0.02em}.cv h1{font-size:41.2px;color:#ffffff;background:#8c8c8b;display:inline-block;margin:0;text-transform:uppercase}.cv .bio{font-size:16.4px;color:#ffffff;background:#8c8c8b;display:inline;margin:0;padding:0}",
  map: null
};
...
<div class="${"cv"}"><h1>${escape(data.title)}</h1>
  <div><span class="${"bio"}">${escape(data.bio)}</span></div>
