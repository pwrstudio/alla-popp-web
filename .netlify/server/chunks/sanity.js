...
const renderBlockText = (text) => blocksToHtml({
  blocks: text,
  serializers,
  projectId: SANITY_PROJECT_ID,
  dataset: "production"
  ...
  types: {
    ...
    image: (props) => {
      return h("figure", { className: "image" }, [
        h("img", {
          src: urlFor(get(props, "node.asset", "")).width(1200).quality(100).auto("format").url()
        }),
        ...
        return h("figure", { className: "youtube" }, [
          h(
            ...
            h("iframe", {
              width: "720",
              height: "480",
              src: "https://www.youtube.com/embed/" + getVideoId(props.node.url).id,
              frameborder: "no",
        ...
        return h("figure", { className: "vimeo" }, [
          h(
            ...
            h("iframe", {
              width: "720",
              height: "480",
              src: "https://player.vimeo.com/video/" + getVideoId(props.node.url).id,
              frameborder: "no",
              byline: false,
              color: "#ffffff",
        ...
        return h("figure", { className: "soundcloud" }, [
          h(
            ...
            h("iframe", {
              width: "100%",
              height: "300",
              src: "https://w.soundcloud.com/player/?url=" + get(props, "node.url", "") + "&color=%23fffff",
              frameborder: "no",
              scrolling: "no",
              allow: "autoplay"
            })
